...
async def start(event):
  await event.reply(
    "__**I'm MentionAll Bot**, I will help you to mention near about all members in your group and channel 👻\nClick **/help** for more information__\n\n join now [chat group](https://t.me/+K4n592296PI1YTg1) injoy😎😊",
    link_preview=False,
    buttons=(
      [
        Button.url('📣 Channel', 'https://t.me/+lSwjStzsHrVlMmZl'),
        Button.url('📦 Source', 'https://github.com//MentionAll_Bot')
      ]
    )
  )
...
async def help(event):
  ...
  await event.reply(
    ...
    buttons=(
      [
        Button.url('📣 Channel', 'https://t.me/+lSwjStzsHrVlMmZl'),
        Button.url('📦 Source', 'https://github.comentionAll_Bot')
      ]
    )
  )
